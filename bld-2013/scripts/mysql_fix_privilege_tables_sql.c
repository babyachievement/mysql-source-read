...
"  IF @duplicate_hosts > 1 THEN\n"
  "    SIGNAL SQLSTATE '45000'  SET MESSAGE_TEXT = 'Multiple accounts exist for @user_name, @host_name that differ only i"
  "n Host lettercase; remove all except one of them';\n",
"  END IF;\n",
"END //\n"
  "DELIMITER ;\n",
