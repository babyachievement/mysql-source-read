...
SET(CMAKE_SOURCE_DIR "D:/mysql/mysql-5.6.24")
SET(CMAKE_CURRENT_BINARY_DIR "D:/mysql/mysql-5.6.24/bld-2013/sql")
SET(MYSQLD_EXECUTABLE "D:/mysql/mysql-5.6.24/bld-2013/sql/$(Configuration)/mysqld.exe")
...
EXECUTE_PROCESS(
  COMMAND "C:/CMake/bin/cmake.exe" -E echo Executing ${BOOTSTRAP_COMMAND}
)
EXECUTE_PROCESS (
  COMMAND "C:/CMake/bin/cmake.exe" -E
...
EXECUTE_PROCESS (  
  COMMAND "C:/CMake/bin/cmake.exe" -E touch ${CMAKE_CURRENT_BINARY_DIR}/initdb.dep
)
